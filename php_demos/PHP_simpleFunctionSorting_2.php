...
<body>
  ...
  // $filterByAuthor = function ($books, $author) {} ----> Lamda Function or Anonymous Function

  function filterByAuthor($books, $author)
  {
    $filteredAuthor = [];
    foreach ($books as $bookFilter) {
      if ($bookFilter['author'] === $author) {
        $filteredAuthor[] = $bookFilter;
      }
    }
    return $filteredAuthor;
  }

  $filteredByAuthor = filterByAuthor($books, 'First Author');
